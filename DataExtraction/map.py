...
def main(DATADIR):
    ...
    df_provinces = pd.read_csv(DATADIR + sep + 'provinces_stage1.csv', index_col=0) # Imported from file that collects province data from history file
    ...
    df_provinces.to_csv(DATADIR + sep + "provinces_stage2.csv")
    return
